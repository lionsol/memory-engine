...
1. **D.3-C.13 INTERNAL_AGENT_CONTEXT Projection Contract Prototype** — `CANDIDATE / NOT AUTHORIZED BY C.12`; pure offline source, bounded caller-supplied synthetic segments, and handcrafted tests only after Planner acceptance.
