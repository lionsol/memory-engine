...
1. **D.3-C.16 INTERNAL_AGENT_CONTEXT Holdout First Run** — `CANDIDATE / NOT AUTHORIZED BY C.15`; only a separately authorized one-shot run may read the frozen C.14 fixture and record evidence.
