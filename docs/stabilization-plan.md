...
5. **B5 — Cross-dataset conversational generalization: `LATER / NOT STARTED`**. Add LoCoMo only after B4 is stable; use it to test longer conversational/persona/event memory rather than retune LongMemEval-specific rules.
