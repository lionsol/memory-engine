...
The current benchmark decision is **B6-I3 `SOURCE IMPLEMENTATION REPO-TESTED /
CLOSED`** after I2a semantic backend/resource ownership, I2b retained-root
restart/reconciliation, and the benchmark-local HTTP/Docker transport. B6-S1
local synthetic HTTP/Docker qualification is next and uses no real provider.
