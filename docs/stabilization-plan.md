...
1. **D.3-C.15 Pure Independent INTERNAL_AGENT_CONTEXT Evaluator** — `CANDIDATE / NOT AUTHORIZED BY C.14`; it must accept caller-supplied rows and keep the frozen C.14 fixture unevaluated until separately authorized.
