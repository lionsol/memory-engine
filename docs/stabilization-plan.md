...
1. **D.3-C.10 Structured Redaction Evidence Contract** — `NEXT / CANDIDATE / NOT AUTHORIZED BY C.9`; pure offline authority/evidence envelope and validation only.
