...
1. **`INTERNAL_AGENT_CONTEXT` design for raw/tool output** — `NEXT / SEPARATE DESIGN DECISION`; C.3 identified this unresolved representation problem, and C.11 does not authorize implementation.
