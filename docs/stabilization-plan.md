...
1. **D.3-C.16 INTERNAL_AGENT_CONTEXT Holdout First Run** — `ONE-SHOT FIRST-RUN EVIDENCE RECORDED / AWAITING PLANNER ADJUDICATION`; the frozen C.14 fixture was read exactly once under the separate execution authorization, with no retry or second execution.
