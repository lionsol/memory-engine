...
lexical v2 without threshold changes. Semantic v2 is **`NEXT / SOURCE
IMPLEMENTATION NOT STARTED / PROVIDER RUN NOT AUTHORIZED`**, and B5 overall
remains **`OPEN`**. Benchmark evidence is not production authority.
