...
| 离线 candidate 与 rollback rehearsal | [`smoke-tests/personal-runtime-candidate-rehearsal-decision-20260721.md`](smoke-tests/personal-runtime-candidate-rehearsal-decision-20260721.md) | R6.4 executed / EDI verification pending | 记录 frozen candidate、native smokes、parity=0、独立 C0/R0、隔离 OpenClaw forward→rollback→forward 演练，以及 install-time plugin import 与 stable-cwd 新约束 |
