...
| 持久 artifact rebuild 与 recovery-source rebase 设计 | [`smoke-tests/personal-runtime-persistent-artifact-rebase-design-20260721.md`](smoke-tests/personal-runtime-persistent-artifact-rebase-design-20260721.md) | R6.5.3 implemented / verification pending | 恢复 `$HOME/.openclaw/backups` 持久 authority；先离线重建 candidate/R0，再以独立 live 事务仅 rebase 相同 runtime 的 sourcePath，candidate 激活另行授权 |
