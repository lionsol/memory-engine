...
| 离线持久 artifact preparation 授权包 | [`smoke-tests/personal-runtime-persistent-artifact-preparation-authorization-20260721.md`](smoke-tests/personal-runtime-persistent-artifact-preparation-authorization-20260721.md) | R6.5.3A implemented / verification pending | 绑定执行时 clean HEAD、active runtime、Gateway 与持久 parent；只允许离线 staging、验证、冻结和 atomic publication，不允许 Gateway、OpenClaw、配置或数据 mutation |
