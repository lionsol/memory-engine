...
| Live runtime remediation 授权包 | [`smoke-tests/personal-runtime-live-remediation-authorization-20260721.md`](smoke-tests/personal-runtime-live-remediation-authorization-20260721.md) | R6.5 implemented / verification pending | 绑定 canonical artifact manifest、fresh C0/R0/D0、精确 stop/install/start、安装前后数据身份门、Gateway RPC 验证及条件 rollback；live execution 仍需明确 operator approval |
...
- **R6.5 live remediation authorization packet**：见 [`smoke-tests/personal-runtime-live-remediation-authorization-20260721.md`](smoke-tests/personal-runtime-live-remediation-authorization-20260721.md)。使用 `memory-engine-runtime-artifact-manifest-v1` 精确绑定 candidate/R0，要求 fresh C0/R0/D0、稳定 cwd、安装前后数据身份一致、Gateway RPC 和显式 operator approval；当前不授权 live execution。
