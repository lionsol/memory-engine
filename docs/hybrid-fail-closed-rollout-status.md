...
| B8-A7 sustained production evidence window | DESIGN AUTHORIZED / RUNTIME NOT AUTHORIZED | Stage 4 proved controlled wiring, and A7.1 identity governance is closed, but continuity, traffic-origin, and sustained health evidence are not authorized or complete. A7.2–A7.3 review remains required before any 30-day full-mode or sustained AutoRecall configuration is authorized. |
