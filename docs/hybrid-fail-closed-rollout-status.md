...
| B8-A7 sustained production evidence window | DESIGN AUTHORIZED / RUNTIME NOT AUTHORIZED | Stage 4 controlled wiring and A7.1/A7.2 evidence governance are closed, but A7.3 sustained health monitoring and stop/rollback automation have not been implemented or reviewed. No 30-day full-mode or sustained AutoRecall configuration is authorized. |
