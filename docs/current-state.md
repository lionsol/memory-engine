...
- `accepted_design`: the Phase 2.5-A Canonical Memory Object contract at `docs/canonical-memory-object-contract.md` is now ready for review/finalization because L2 is complete. This draft does not itself authorize 2.5-B implementation.
