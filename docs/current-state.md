...
- `accepted_design`: with persistent-activation qualification closed, the next product architecture phase is Phase 2.5 — Memory Canonicalization / Projection. Its detailed object contract and implementation semantics are intentionally deferred to the later product-design session; this governance closeout does not define or authorize them.
