...
| [`candidate-builder-harness-design-20260805.md`](candidate-builder-harness-design-20260805.md) | Accepted contract and committed source implementation for a deterministic, single-entry, fail-closed offline authority builder | Synthetic production verification passed; no real plan execution, real candidate construction, runtime install, service mutation, or real data access |
| [`candidate-builder-harness-execution-template.md`](candidate-builder-harness-execution-template.md) | One-shot real-plan dry-run/prepare authorization template | Dry-run and prepare authorizations remain separate; no automatic retry, live install, sourcePath repair, service operation, tag, or push |
