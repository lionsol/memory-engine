...
function makeCollectorStats(targetDate, timeZone) {
  return {
    ...
    evidenceDateFilter: `targetDate=${targetDate}; timeZone=${timeZone}; smartAdd=memory/smart-add/${targetDate}.md; raw_log=updated_at bounded to targetDate`,
    smartAddIncluded: 0,
    smartAddSkippedUnknownProvenance: 0,
    smartAddSkippedCheckpointGenerated: 0,
    budgets: { ...DEFAULT_BUDGETS },
    rawLogTimeBasis: "updated_at",
    rawLogTimeBasisNote: "updated_at may reflect write/update time, not original event time",
    rawLogIncluded: 0,
