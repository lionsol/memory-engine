 ...
 * @returns {Promise<{memories: Array<object>, orderedIds: string[], status: string, reason: string, scores: Record<string, number|null>, usage: unknown, adapterIdentity: unknown, elapsedMs: number, projectionElapsedMs: number, projectionMetadata: Array<object>, totalCodePoints: number}>}
 */
