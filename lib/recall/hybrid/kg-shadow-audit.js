...
async function executeKgShadowRun({
  ...
  const ctx = buildKgChannelContext({
    ...
    // This is an audit-only direct collector comparison. The flag is never
    // carried through hybridSearch or a production channel runtime.
    legacyFallbackAllowed: mode !== "isolated",
    nowSec,
    minConfidence,
    ftsTopK,
    likePatternTopN,
