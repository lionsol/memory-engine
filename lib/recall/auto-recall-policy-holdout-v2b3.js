...
const B3_HISTORICAL_STATUS = "PASS_WITH_FINDINGS / HOLDOUT NOT READY";
const B3_CURRENT_EVIDENCE_ROLE = "known_regression_after_v2b4";
const B3_CURRENT_STATUS = "REGRESSION ONLY / NOT INDEPENDENT READINESS EVIDENCE";
...
function finalizeReport(report, contract) {
  ...
  return {
    ...
    family_metrics,
    readiness,
    evidence_role: B3_CURRENT_EVIDENCE_ROLE,
    current_evaluation_status: readiness.overall_status,
    historical_b3_status: B3_HISTORICAL_STATUS,
    candidate_policy_status: "NOT RUNTIME AUTHORIZED",
