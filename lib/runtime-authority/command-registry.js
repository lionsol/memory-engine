...
function createRegistry({ plan, broker, spawn, sandbox } = {}) {
  ...
  const descriptors = {
    ...
    "systemd.gateway_status": { class: "host", executable: executable("systemctl_executable"), args: p => ["show", p.gateway_unit, "--property=ActiveState,SubState,MainPID,NRestarts", "--value"] },
    "systemd.console_status": { class: "host", executable: executable("systemctl_executable"), args: p => ["show", p.console_unit, "--property=ActiveState,SubState,MainPID,NRestarts", "--value"] },
...
module.exports = { CommandRegistry, createRegistry, defaultSpawn, fixedEnv };
