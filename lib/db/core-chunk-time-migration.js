...
import { denyCoreWriteCapability } from "./core-write-guard.js";
...
export function inspectCoreChunkTimeMigration(options = {}) {
  ...
  return {
    ...
    apply_prohibited: true,
    write_prohibition_code: "CORE_WRITE_PROHIBITED",
    writes_db: false,
  };
}
...
export function applyCoreChunkTimeMigration() {
  denyCoreWriteCapability("core-chunk-time-migration");
}
