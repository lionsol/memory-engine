...
export const C1A_LOCOMO_0_6B_QUALIFICATION_PROFILE = "r3_c1a_locomo_fts20_canonical_qwen3_0_6b_v1";
...
export function resolveC1AQualificationProfile(rerankModel) {
  if (rerankModel === SILICONFLOW_RERANK_MODEL) return C1A_LOCOMO_QUALIFICATION_PROFILE;
  if (rerankModel === SILICONFLOW_RERANK_MODEL_0_6B) return C1A_LOCOMO_0_6B_QUALIFICATION_PROFILE;
  throw fail("C1A_LOCOMO_RERANK_MODEL_NOT_ALLOWED", { rerankModel });
}
...
export function prepareC1ALocomoQualification({
  ...
  material.qualification_profile = resolveC1AQualificationProfile(rerankModel);
