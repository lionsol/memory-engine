...
export function formatSemanticQueryInstructionEmbeddingInput(exactVectorQueryInput) {
  if (typeof exactVectorQueryInput !== "string") {
    throw new TypeError("exact production vector query input must be a string");
  }
  return `${SEMANTIC_QUERY_INSTRUCTION_TEXT}\nQuery:${exactVectorQueryInput}`;
}
