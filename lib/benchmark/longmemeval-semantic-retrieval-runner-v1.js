...
function provenance({
  ...
  const extraProvenance = profileProvenance && typeof profileProvenance === "object" && !Array.isArray(profileProvenance)
    ? { ...profileProvenance }
    : {};
  try {
    assertNoGoldFields(extraProvenance, "semantic_profile_provenance");
  } catch (error) {
