...
export function scoreLocomoChunkCase({
  ...
  if (missingChunkIds.length > 0) {
    return scoreUnknownCase(identity, "selected_chunk_id_not_found", {
      ...
      frozen_material_scoreable: frozenUnknownEvidenceIds.length === 0,
...
export function scoreLocomoChunkCases({
  ...
  return {
    ...
    population: {
      ...
      frozen_material_scoreable_case_count: cases.length - frozenMaterialUnknownCaseCount,
      frozen_material_unknown_case_count: frozenMaterialUnknownCaseCount,
      final_scoreable_case_count: cases.filter(row => row.scoreable === true).length,
      final_unknown_case_count: cases.filter(row => row.scoreable !== true).length,
