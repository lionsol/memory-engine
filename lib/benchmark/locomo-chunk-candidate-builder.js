...
export const LOCOMO_CHUNK_CANDIDATE_SOURCE_COMMIT = "aa2e65ffa2f04d991026d03bc97aebecce944412";
...
export const LOCOMO_CHUNK_FTS_ONLY_PROFILE = Object.freeze({
  ...
  source_commit: LOCOMO_CHUNK_CANDIDATE_SOURCE_COMMIT,
  candidate_depth: 50,
  fts_top_k: 50,
...
function validateProfile(profile) {
  ...
  if (profile.source_commit !== LOCOMO_CHUNK_CANDIDATE_SOURCE_COMMIT) {
    throw new Error("candidate_profile_source_commit_invalid");
  }
