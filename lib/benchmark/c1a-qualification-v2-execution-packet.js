...
export const C1A_V2_EXPECTED_PRIOR_OBSERVED_MANIFEST_SHA256 = "c723886df9083bdd72753059afc4773195707d96077946b384eb163df725b272";

export function buildC1AV2ExecutionPacket({
  manifest,
  sourceCommit,
  executionRoot,
  maxCostUsd,
  ...
  const packet = {
    ...
    max_input_tokens: C1A_MAX_INPUT_TOKENS,
  ...
  return Object.freeze({
    ...packet,
    egress: Object.freeze({ ...packet.egress }),
    pacing: Object.freeze({ ...packet.pacing }),
    rate_limits: Object.freeze({ ...packet.rate_limits }),
  });
}
...
export function validateC1AV2ExecutionPacket({
  ...
  if (typeof expectedPriorObservedManifestSha256 !== "string"
      || expectedPriorObservedManifestSha256.length !== 64
      || manifest.prior_observed_manifest_sha256 !== expectedPriorObservedManifestSha256) {
    throw fail("C1A_V2_EXECUTION_PRIOR_MANIFEST_NOT_FROZEN_M2");
  }
